...
function NoiseModuleTree:bias(module)
	...
	local f=anl.CImplicitBias(bias)
...
function NoiseModuleTree:gain(module)
	...
	local f=anl.CImplicitGain(bias)
...
function NoiseModuleTree:rotatedomain(module)
	...
	local f=anl.CImplicitRotateDomain()
...
function NoiseModuleTree:sphere(module)
	...
	local cx=self:verifyScalarParamter(module,"cx")
	local cy=self:verifyScalarParamter(module,"cy")
	local cz=self:verifyScalarParamter(module,"cz")
	local cw=self:verifyScalarParamter(module,"cw")
	local cu=self:verifyScalarParamter(module,"cu")
	local cv=self:verifyScalarParamter(module,"cv")
...
function NoiseModuleTree:rgba_composechannels(module)
	...
	local a=self:verifyScalarParamter(module,"alpha")
